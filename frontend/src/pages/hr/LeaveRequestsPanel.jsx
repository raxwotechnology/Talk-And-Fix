    ...
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
        <div>
          ...
          <select value={filter} onChange={(e) => setFilter(e.target.value)} className="w-full border border-card-border rounded-xl py-2 px-3 text-sm focus:outline-none focus:ring-2 focus:ring-primary-blue bg-white">
        ...
        <div>
          ...
          <select value={roleFilter} onChange={(e) => setRoleFilter(e.target.value)} className="w-full border border-card-border rounded-xl py-2 px-3 text-sm focus:outline-none focus:ring-2 focus:ring-primary-blue bg-white">
        ...
        <div>
          ...
          <input
            ...
            className="w-full border border-card-border rounded-xl py-2 px-3 text-sm focus:outline-none focus:ring-2 focus:ring-primary-blue bg-white"
          />
        </div>
      </div>
